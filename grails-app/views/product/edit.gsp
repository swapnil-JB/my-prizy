...
<html>
	...
	<body>
		...
		<div id="edit-product" class="content scaffold-edit middleDiv" role="main">
			...
			<g:form url="[resource:productInstance, action:'update']" method="PUT" >
				...
				<fieldset class="buttons">
					<g:actionSubmit params="[barcode: "${productInstance.barcode}"]" class="save" action="update" value="${message(code: 'default.button.update.label', default: 'Update')}" />
				</fieldset>
			</g:form>
		</div>
	</body>
